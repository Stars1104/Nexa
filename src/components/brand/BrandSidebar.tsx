...
import { Home, FileText, MessageCircle, User, BanknoteIcon } from "lucide-react";
...
const navLinks = [
    { label: "Minhas Campanhas", icon: Home, key: "my campaigns" },
    { label: "New Camping Day", icon: FileText, key: "new campaign" },
    { label: "Conversas", icon: MessageCircle, key: "conversations" },
    { label: "Meu Perfil", icon: User, key: "my account" },
    { label: "Pagamentos", icon: BanknoteIcon, key: "payment" },
];
