...
export default function Portfolio() {
    ...
    useEffect(() => {
        if (portfolio) {
            ...
            console.log('Portfolio bio:', portfolio.bio);
            ...
            console.log('  profileTitle state:', portfolio.title || "");
            console.log('  bio state:', portfolio.bio || "");
        }
    }, [portfolio]);
    ...
    const handleSaveProfile = async () => {
        ...
        try {
            ...
            console.log('  titleToSend:', titleToSend);
            console.log('  bioToSend:', bioToSend);
            ...
            console.log('  profileTitle type:', typeof profileTitle);
            console.log('  bio type:', typeof bio);
            console.log('  profileTitle length:', profileTitle?.length);
            ...
            if (profilePic && profilePic.startsWith('blob:')) {
                ...
                console.log('Profile picture blob added to FormData');
            }

            console.log('About to dispatch updatePortfolioProfile...');
